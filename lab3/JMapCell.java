...
public class JMapCell extends JComponent {
    ...
    /**
     * Construct a new map cell with the specified "passability." An input of true
     * means the cell is passable.
     **/
    ...
    /**
     * Sets this cell to be passable or not passable. An input of true marks the
     * cell as passable; an input of false marks it as not passable.
     **/
    ...
    /**
     * This helper method updates the background color to match the current internal
     * state of the cell.
     **/
    ...
    /**
     * Implementation of the paint method to draw the background color into the map
     * cell.
     **/
