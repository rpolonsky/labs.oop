...
public class Map2D {
    ...
    /**
     * This helper method checks the specified coordinates to see if they are within
     * the map's boundaries. If the coordinates are not within the map then the
    ...
    /**
     * Returns the starting location for the map. This is where the generated path
     * will begin from.
     **/
    ...
    /**
     * Sets the starting location for the map. This is where the generated path will
     * begin from.
     **/
    ...
    /**
     * Returns the ending location for the map. This is where the generated path
     * will terminate.
     **/
    ...
    /**
     * Sets the ending location for the map. This is where the generated path will
     * terminate.
     **/
